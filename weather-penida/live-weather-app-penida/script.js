...
//    });
    ...
    function initApp() {
		...
		//getWeatherByCoords=-8.727807,115.544426;
  ...
  //  }
    ...
    async function getWeatherByCity(city) {
        ...
        try {
            ...
            const currentResponse = await fetch(
                `https://api.openweathermap.org/data/2.5/weather?lat=-8.727807&lon=115.544426&units=metric&appid=21480b77eb33ed197e62b8e6a1422a57`
            );
    ...
    async function getWeatherByCoords(lat, lon) {
        ...
        try {
            ...
            // Get forecast
            const forecastResponse = await fetch(
                `https://api.openweathermap.org/data/2.5/forecast?lat=-8.727807&lon=115.544426&units=metric&appid=21480b77eb33ed197e62b8e6a1422a57`
            );
    ...
    function updateForecast(forecastData) {
        ...
        // Get the next 7 days
        const days = Object.keys(dailyForecasts).slice(0, 100);
